##
## SAMPLE EMCEE EXAMPLE DRIVER FOR P-MEDDS PACKAGE - USING A COMPARTMENTAL SIR MODEL AND ILI DATA OF EITHER MILITARY (MPZ), CDC OR GFT DATA
##
...
runPMEDDS.EMCEE.demo(dataType=dataType,job.year=job.year,region=iregion,national=national)
