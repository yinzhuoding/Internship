...
plot.input.data(myName=mydata$dataName,FY=mydata$FY,nweeksFit=50,nweeksData=mydata$nweeks,week=mydata$weeks,epi=mydata$cases,sh=mydata$sh,school=mydata$school,log=logfile,device.name = "pdf")
#################
