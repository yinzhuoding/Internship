...
mapMovie = function(device = "mp4") {
  ...
  if (device == "mp4") {
    moviename = "map.mp4"
    suppressMessages(saveVideo(map.animate(),interval = 0.2, movie.name = moviename))
    setwd(mainDir)
...
# dataType = "cdc", year = NULL, mod_level = NULL, fit_level = NULL, nweeksFit = 52, model = 5, isingle = 0, nMCMC = 1e+05, nreal = 1, device = "pdf", prior = 0, Temp = 1, RegState = 'usa', subDir = NULL, plot = 1, emcee = FALSE, nwalk = 1
